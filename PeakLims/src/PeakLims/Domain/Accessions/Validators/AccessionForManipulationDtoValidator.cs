...
public class AccessionForManipulationDtoValidator<T> : AbstractValidator<T> where T : AccessionForManipulationDto
{
    public AccessionForManipulationDtoValidator()
    {
