...
public class TestOrderForManipulationDtoValidator<T> : AbstractValidator<T> where T : TestOrderForManipulationDto
{
    public TestOrderForManipulationDtoValidator()
    {
