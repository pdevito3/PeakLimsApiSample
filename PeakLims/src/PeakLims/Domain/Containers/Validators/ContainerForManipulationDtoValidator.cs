...
public class ContainerForManipulationDtoValidator<T> : AbstractValidator<T> where T : ContainerForManipulationDto
{
    public ContainerForManipulationDtoValidator()
    {
